			...
			<tr>
				...
				<td>
					<div class="input-group mb-3">
						...
						<input type="text" name="old_url" placeholder="старый адрес..." class="form-control" style="max-width:350px;" required/>
					</div>
				</td>
				...
				<td>
					<div class="input-group mb-3">
						...
						<input type="text" name="new_url" placeholder="новый адрес..." class="form-control" style="max-width:350px;" required/>
					</div>
				</td>
				<td><label style="padding: .375rem 0rem .75rem 0rem;">Редирект активен</label></td>
				<td>
					<div class="input-group mb-3">
						<input class="icheck" type="checkbox" name="active" id="active" value="1" checked>
					</div>
				</td>
			</tr>				
		</table>
